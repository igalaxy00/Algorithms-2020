...
//my test
        assertEquals("", longestCommonSubSequence("семнадцать", "",))
        assertEquals("", longestCommonSubSequence("", "семнадцать",))
        assertEquals("", longestCommonSubSequence("я", "как дела",))
...
//my test
        ...
        assertEquals(listOf(8), longestIncreasingSubSequence(listOf(8, 7, 6, 5, 4, 3)))
    }
